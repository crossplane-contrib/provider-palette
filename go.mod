module github.com/crossplane-contrib/provider-palette
...
replace github.com/crossplane/crossplane-runtime v1.21.0-rc.0.0.20250722143302-1e3dba95eead => github.com/crossplane/crossplane-runtime v1.21.0-rc.0
