...
type AKSClusterInitParameters struct {
	...
	// (String)
	// +crossplane:generate:reference:type=github.com/crossplane-contrib/provider-palette/apis/azure/v1alpha1.AzureCloudAccount
	CloudAccountID *string `json:"cloudAccountId,omitempty" tf:"cloud_account_id,omitempty"`

	// Reference to a AzureCloudAccount in azure to populate cloudAccountId.
	// +kubebuilder:validation:Optional
	CloudAccountIDRef *v1.Reference `json:"cloudAccountIdRef,omitempty" tf:"-"`

	// Selector for a AzureCloudAccount in azure to populate cloudAccountId.
	// +kubebuilder:validation:Optional
