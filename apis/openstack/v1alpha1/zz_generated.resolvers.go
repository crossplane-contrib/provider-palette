...
// ResolveReferences of this OpenstackCluster.
func (mg *OpenstackCluster) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	rsp, err = r.Resolve(ctx, reference.ResolutionRequest{
		...
		To: reference.To{
			List:    &OpenstackCloudAccountList{},
			Managed: &OpenstackCloudAccount{},
		},
	})
	if err != nil {
