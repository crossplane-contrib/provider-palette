...
type OpenstackClusterInitParameters struct {
	...
	// (String)
	// +crossplane:generate:reference:type=github.com/crossplane-contrib/provider-palette/apis/openstack/v1alpha1.OpenstackCloudAccount
	CloudAccountID *string `json:"cloudAccountId,omitempty" tf:"cloud_account_id,omitempty"`

	// Reference to a OpenstackCloudAccount in openstack to populate cloudAccountId.
	// +kubebuilder:validation:Optional
	CloudAccountIDRef *v1.Reference `json:"cloudAccountIdRef,omitempty" tf:"-"`

	// Selector for a OpenstackCloudAccount in openstack to populate cloudAccountId.
	// +kubebuilder:validation:Optional
...
type OpenstackClusterObservation struct {
...
type OpenstackClusterParameters struct {
...
type OpenstackClusterSpec struct {
	...
	ForProvider     OpenstackClusterParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider OpenstackClusterInitParameters `json:"initProvider,omitempty"`
}

// OpenstackClusterStatus defines the observed state of OpenstackCluster.
type OpenstackClusterStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        OpenstackClusterObservation `json:"atProvider,omitempty"`
}
...
// OpenstackCluster is the Schema for the OpenstackClusters API. Resource for managing Openstack clusters in Spectro Cloud through Palette.
...
// OpenstackClusterList contains a list of OpenstackClusters
...
var (
	OpenstackCluster_Kind             = "OpenstackCluster"
	OpenstackCluster_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: OpenstackCluster_Kind}.String()
	OpenstackCluster_KindAPIVersion   = OpenstackCluster_Kind + "." + CRDGroupVersion.String()
	OpenstackCluster_GroupVersionKind = CRDGroupVersion.WithKind(OpenstackCluster_Kind)
)
