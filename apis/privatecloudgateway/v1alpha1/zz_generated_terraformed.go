...
func (tr *Ippool) GetObservation() (map[string]interface{}, error) {
...
func (tr *Ippool) SetObservation(obs map[string]interface{}) error {
...
func (tr *Ippool) GetParameters() (map[string]interface{}, error) {
...
func (tr *Ippool) SetParameters(params map[string]interface{}) error {
