...
type MAASClusterInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/crossplane-contrib/provider-palette/apis/maas/v1alpha1.MAASCloudAccount
	CloudAccountID *string `json:"cloudAccountId,omitempty" tf:"cloud_account_id,omitempty"`

	// Reference to a MAASCloudAccount in maas to populate cloudAccountId.
	// +kubebuilder:validation:Optional
	CloudAccountIDRef *v1.Reference `json:"cloudAccountIdRef,omitempty" tf:"-"`

	// Selector for a MAASCloudAccount in maas to populate cloudAccountId.
	// +kubebuilder:validation:Optional
...
type MAASClusterObservation struct {
...
type MAASClusterParameters struct {
...
type MAASClusterSpec struct {
	...
	ForProvider     MAASClusterParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider MAASClusterInitParameters `json:"initProvider,omitempty"`
}

// MAASClusterStatus defines the observed state of MAASCluster.
type MAASClusterStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        MAASClusterObservation `json:"atProvider,omitempty"`
}
...
// MAASCluster is the Schema for the MAASClusters API. Resource for managing MAAS clusters in Spectro Cloud through Palette.
...
// MAASClusterList contains a list of MAASClusters
...
var (
	MAASCluster_Kind             = "MAASCluster"
	MAASCluster_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: MAASCluster_Kind}.String()
	MAASCluster_KindAPIVersion   = MAASCluster_Kind + "." + CRDGroupVersion.String()
	MAASCluster_GroupVersionKind = CRDGroupVersion.WithKind(MAASCluster_Kind)
)
