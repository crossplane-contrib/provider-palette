...
func (tr *StorageLocation) GetObservation() (map[string]interface{}, error) {
...
func (tr *StorageLocation) SetObservation(obs map[string]interface{}) error {
...
func (tr *StorageLocation) GetParameters() (map[string]interface{}, error) {
...
func (tr *StorageLocation) SetParameters(params map[string]interface{}) error {
