...
type ProjectRoleInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/crossplane-contrib/provider-palette/apis/accesscontrol/v1alpha1.Role
	// +listType=set
	RoleIds []*string `json:"roleIds,omitempty" tf:"role_ids,omitempty"`

	// References to Role in accesscontrol to populate roleIds.
	// +kubebuilder:validation:Optional
	RoleIdsRefs []v1.Reference `json:"roleIdsRefs,omitempty" tf:"-"`

	// Selector for a list of Role in accesscontrol to populate roleIds.
	// +kubebuilder:validation:Optional
...
type ResourceRoleInitParameters struct {
	...
	// List of filter ids.
	// +crossplane:generate:reference:type=github.com/crossplane-contrib/provider-palette/apis/monitoring/v1alpha1.Filter
	// +listType=set
	FilterIds []*string `json:"filterIds,omitempty" tf:"filter_ids,omitempty"`

	// References to Filter in monitoring to populate filterIds.
	// +kubebuilder:validation:Optional
	FilterIdsRefs []v1.Reference `json:"filterIdsRefs,omitempty" tf:"-"`

	// Selector for a list of Filter in monitoring to populate filterIds.
	// +kubebuilder:validation:Optional
...
type UserInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/crossplane-contrib/provider-palette/apis/accesscontrol/v1alpha1.Team
	TeamIds []*string `json:"teamIds,omitempty" tf:"team_ids,omitempty"`

	// References to Team in accesscontrol to populate teamIds.
	// +kubebuilder:validation:Optional
	TeamIdsRefs []v1.Reference `json:"teamIdsRefs,omitempty" tf:"-"`

	// Selector for a list of Team in accesscontrol to populate teamIds.
	// +kubebuilder:validation:Optional
	...
	// References to Role in accesscontrol to populate tenantRole.
	// +kubebuilder:validation:Optional
	TenantRoleRefs []v1.Reference `json:"tenantRoleRefs,omitempty" tf:"-"`

	// Selector for a list of Role in accesscontrol to populate tenantRole.
	// +kubebuilder:validation:Optional
