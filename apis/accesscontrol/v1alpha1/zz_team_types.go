...
type ProjectRoleMappingInitParameters struct {
	...
	// References to Role in accesscontrol to populate roles.
	// +kubebuilder:validation:Optional
	RolesRefs []v1.Reference `json:"rolesRefs,omitempty" tf:"-"`

	// Selector for a list of Role in accesscontrol to populate roles.
	// +kubebuilder:validation:Optional
...
type TeamInitParameters struct {
	...
	// References to Role in accesscontrol to populate tenantRoleMapping.
	// +kubebuilder:validation:Optional
	TenantRoleMappingRefs []v1.Reference `json:"tenantRoleMappingRefs,omitempty" tf:"-"`

	// Selector for a list of Role in accesscontrol to populate tenantRoleMapping.
	// +kubebuilder:validation:Optional
	...
	// +crossplane:generate:reference:type=github.com/crossplane-contrib/provider-palette/apis/accesscontrol/v1alpha1.User
	// +listType=set
	Users []*string `json:"users,omitempty" tf:"users,omitempty"`

	// References to User in accesscontrol to populate users.
	// +kubebuilder:validation:Optional
	UsersRefs []v1.Reference `json:"usersRefs,omitempty" tf:"-"`

	// Selector for a list of User in accesscontrol to populate users.
	// +kubebuilder:validation:Optional
