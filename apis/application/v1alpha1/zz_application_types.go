...
type ApplicationInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/crossplane-contrib/provider-palette/apis/application/v1alpha1.ApplicationProfile
	ApplicationProfileUID *string `json:"applicationProfileUid,omitempty" tf:"application_profile_uid,omitempty"`

	// Reference to a ApplicationProfile in application to populate applicationProfileUid.
	// +kubebuilder:validation:Optional
	ApplicationProfileUIDRef *v1.Reference `json:"applicationProfileUidRef,omitempty" tf:"-"`

	// Selector for a ApplicationProfile in application to populate applicationProfileUid.
	// +kubebuilder:validation:Optional
...
type ConfigInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/crossplane-contrib/provider-palette/apis/clustergroup/v1alpha1.ClusterGroup
	ClusterGroupUID *string `json:"clusterGroupUid,omitempty" tf:"cluster_group_uid,omitempty"`

	// Reference to a ClusterGroup in clustergroup to populate clusterGroupUid.
	// +kubebuilder:validation:Optional
	ClusterGroupUIDRef *v1.Reference `json:"clusterGroupUidRef,omitempty" tf:"-"`

	// Selector for a ClusterGroup in clustergroup to populate clusterGroupUid.
	// +kubebuilder:validation:Optional
	...
	// +crossplane:generate:reference:type=github.com/crossplane-contrib/provider-palette/apis/virtualcluster/v1alpha1.VirtualCluster
	ClusterUID *string `json:"clusterUid,omitempty" tf:"cluster_uid,omitempty"`

	// Reference to a VirtualCluster in virtualcluster to populate clusterUid.
	// +kubebuilder:validation:Optional
	ClusterUIDRef *v1.Reference `json:"clusterUidRef,omitempty" tf:"-"`

	// Selector for a VirtualCluster in virtualcluster to populate clusterUid.
	// +kubebuilder:validation:Optional
