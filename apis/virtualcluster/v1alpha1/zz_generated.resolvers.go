...
import (
	...
	v1alpha11 "github.com/crossplane-contrib/provider-palette/apis/clustergroup/v1alpha1"
	v1alpha12 "github.com/crossplane-contrib/provider-palette/apis/clusterprofile/v1alpha1"
...
func (mg *VirtualCluster) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	rsp, err = r.Resolve(ctx, reference.ResolutionRequest{
		...
		To: reference.To{
			List:    &v1alpha11.ClusterGroupList{},
			Managed: &v1alpha11.ClusterGroup{},
		},
	})
	if err != nil {
	...
	for i3 := 0; i3 < len(mg.Spec.ForProvider.ClusterProfile); i3++ {
		rsp, err = r.Resolve(ctx, reference.ResolutionRequest{
			...
			To: reference.To{
				List:    &v1alpha12.ClusterProfileList{},
				Managed: &v1alpha12.ClusterProfile{},
			},
		})
		if err != nil {
