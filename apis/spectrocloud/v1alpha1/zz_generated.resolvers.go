...
import (
	"context"
	v1alpha11 "github.com/crossplane-contrib/provider-palette/apis/backup/v1alpha1"
	v1alpha1 "github.com/crossplane-contrib/provider-palette/apis/clusterprofile/v1alpha1"
	reference "github.com/crossplane/crossplane-runtime/pkg/reference"
	errors "github.com/pkg/errors"
	client "sigs.k8s.io/controller-runtime/pkg/client"
)

// ResolveReferences of this AddonDeployment.
func (mg *AddonDeployment) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	for i3 := 0; i3 < len(mg.Spec.ForProvider.ClusterProfile); i3++ {
		rsp, err = r.Resolve(ctx, reference.ResolutionRequest{
			...
			To: reference.To{
				...
				Managed: &v1alpha1.ClusterProfile{},
			},
		})
		if err != nil {
...
func (mg *Workspace) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	for i3 := 0; i3 < len(mg.Spec.ForProvider.BackupPolicy); i3++ {
		rsp, err = r.Resolve(ctx, reference.ResolutionRequest{
			...
			To: reference.To{
				List:    &v1alpha11.BackupStorageLocationList{},
				Managed: &v1alpha11.BackupStorageLocation{},
			},
		})
		if err != nil {
