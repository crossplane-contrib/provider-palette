...
type AddonDeploymentInitParameters struct {
...
type AddonDeploymentObservation struct {
...
type AddonDeploymentParameters struct {
...
type AddonDeploymentSpec struct {
	...
	ForProvider     AddonDeploymentParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider AddonDeploymentInitParameters `json:"initProvider,omitempty"`
}

// AddonDeploymentStatus defines the observed state of AddonDeployment.
type AddonDeploymentStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        AddonDeploymentObservation `json:"atProvider,omitempty"`
}
...
// AddonDeployment is the Schema for the AddonDeployments API. <no value>
...
type AddonDeployment struct {
	...
	Spec   AddonDeploymentSpec   `json:"spec"`
	Status AddonDeploymentStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// AddonDeploymentList contains a list of AddonDeployments
...
var (
	AddonDeployment_Kind             = "AddonDeployment"
	AddonDeployment_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: AddonDeployment_Kind}.String()
	AddonDeployment_KindAPIVersion   = AddonDeployment_Kind + "." + CRDGroupVersion.String()
	AddonDeployment_GroupVersionKind = CRDGroupVersion.WithKind(AddonDeployment_Kind)
)
