...
type AzureInitParameters struct {
	...
	AzureClientSecretSecretRef v1.LocalSecretKeySelector `json:"azureClientSecretSecretRef" tf:"-"`
	...
	// (String) TLS certificate for authentication. This field is only allowed when cloud is set to 'AzureUSSecretCloud'.
