...
type AwsInitParameters struct {
	...
	// (String) The Amazon Resource Name (ARN) associated with the AWS resource. This is used for identifying resources in AWS. Used for STS credential type.
	...
	// (String, Sensitive) The AWS access key used to authenticate. This is a secure alternative to aws_access_key with sensitive attribute enabled. Note: This field is mutually exclusive with aws_access_key.
	...
	AwsSecuredAccessKeySecretRef *v1.LocalSecretKeySelector `json:"awsSecuredAccessKeySecretRef,omitempty" tf:"-"`
	...
	// account access in AWS. Used for STS credential type.
