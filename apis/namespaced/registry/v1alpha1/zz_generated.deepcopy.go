...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CredentialsTLSConfigInitParameters) DeepCopyInto(out *CredentialsTLSConfigInitParameters) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CredentialsTLSConfigInitParameters.
func (in *CredentialsTLSConfigInitParameters) DeepCopy() *CredentialsTLSConfigInitParameters {
	if in == nil {
		return nil
	}
	out := new(CredentialsTLSConfigInitParameters)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CredentialsTLSConfigObservation) DeepCopyInto(out *CredentialsTLSConfigObservation) {
	*out = *in
	if in.Certificate != nil {
		in, out := &in.Certificate, &out.Certificate
		*out = new(string)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CredentialsTLSConfigObservation.
func (in *CredentialsTLSConfigObservation) DeepCopy() *CredentialsTLSConfigObservation {
	if in == nil {
		return nil
	}
	out := new(CredentialsTLSConfigObservation)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CredentialsTLSConfigParameters) DeepCopyInto(out *CredentialsTLSConfigParameters) {
	*out = *in
	if in.Certificate != nil {
		in, out := &in.Certificate, &out.Certificate
		*out = new(string)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CredentialsTLSConfigParameters.
func (in *CredentialsTLSConfigParameters) DeepCopy() *CredentialsTLSConfigParameters {
	if in == nil {
		return nil
	}
	out := new(CredentialsTLSConfigParameters)
	in.DeepCopyInto(out)
	return out
}
...
func (in *OciCredentialsInitParameters) DeepCopyInto(out *OciCredentialsInitParameters) {
	*out = *in
	...
	if in.TLSConfig != nil {
		in, out := &in.TLSConfig, &out.TLSConfig
		*out = make([]CredentialsTLSConfigInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *OciCredentialsObservation) DeepCopyInto(out *OciCredentialsObservation) {
	*out = *in
	...
	if in.TLSConfig != nil {
		in, out := &in.TLSConfig, &out.TLSConfig
		*out = make([]CredentialsTLSConfigObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *OciCredentialsParameters) DeepCopyInto(out *OciCredentialsParameters) {
	*out = *in
	...
	if in.TLSConfig != nil {
		in, out := &in.TLSConfig, &out.TLSConfig
		*out = make([]CredentialsTLSConfigParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
