...
type TeamInitParameters struct {
	...
	// +kubebuilder:validation:Optional
	TenantRoleMappingRefs []v1.NamespacedReference `json:"tenantRoleMappingRefs,omitempty" tf:"-"`

	// Selector for a list of Role in spectrocloud to populate tenantRoleMapping.
	// +kubebuilder:validation:Optional
	TenantRoleMappingSelector *v1.NamespacedSelector `json:"tenantRoleMappingSelector,omitempty" tf:"-"`

	// (Set of String) List of user ids to be associated with the team.
	// List of user ids to be associated with the team.
	// +crossplane:generate:reference:type=github.com/crossplane-contrib/provider-palette/apis/namespaced/spectrocloud/v1alpha1.User
	// +listType=set
