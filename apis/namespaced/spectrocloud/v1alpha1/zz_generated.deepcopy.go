...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ClusterResourceAllocationsInitParameters) DeepCopyInto(out *ClusterResourceAllocationsInitParameters) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ClusterResourceAllocationsInitParameters.
func (in *ClusterResourceAllocationsInitParameters) DeepCopy() *ClusterResourceAllocationsInitParameters {
	if in == nil {
		return nil
	}
	out := new(ClusterResourceAllocationsInitParameters)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ClusterResourceAllocationsObservation) DeepCopyInto(out *ClusterResourceAllocationsObservation) {
	*out = *in
	if in.ResourceAllocation != nil {
		in, out := &in.ResourceAllocation, &out.ResourceAllocation
		*out = make(map[string]*string, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ClusterResourceAllocationsObservation.
func (in *ClusterResourceAllocationsObservation) DeepCopy() *ClusterResourceAllocationsObservation {
	if in == nil {
		return nil
	}
	out := new(ClusterResourceAllocationsObservation)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ClusterResourceAllocationsParameters) DeepCopyInto(out *ClusterResourceAllocationsParameters) {
	*out = *in
	if in.ResourceAllocation != nil {
		in, out := &in.ResourceAllocation, &out.ResourceAllocation
		*out = make(map[string]*string, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ClusterResourceAllocationsParameters.
func (in *ClusterResourceAllocationsParameters) DeepCopy() *ClusterResourceAllocationsParameters {
	if in == nil {
		return nil
	}
	out := new(ClusterResourceAllocationsParameters)
	in.DeepCopyInto(out)
	return out
}
...
func (in *NamespacesInitParameters) DeepCopyInto(out *NamespacesInitParameters) {
	*out = *in
	if in.ClusterResourceAllocations != nil {
		in, out := &in.ClusterResourceAllocations, &out.ClusterResourceAllocations
		*out = make([]ClusterResourceAllocationsInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *NamespacesObservation) DeepCopyInto(out *NamespacesObservation) {
	*out = *in
	if in.ClusterResourceAllocations != nil {
		in, out := &in.ClusterResourceAllocations, &out.ClusterResourceAllocations
		*out = make([]ClusterResourceAllocationsObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *NamespacesParameters) DeepCopyInto(out *NamespacesParameters) {
	*out = *in
	if in.ClusterResourceAllocations != nil {
		in, out := &in.ClusterResourceAllocations, &out.ClusterResourceAllocations
		*out = make([]ClusterResourceAllocationsParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
