...
func (mg *Trail) GetTerraformResourceType() string {
	return "spectrocloud_audit_trail"
}

// GetConnectionDetailsMapping for this Trail
func (tr *Trail) GetConnectionDetailsMapping() map[string]string {
	return map[string]string{"cloudwatch[*].access_key": "cloudwatch[*].accessKeySecretRef", "cloudwatch[*].external_id": "cloudwatch[*].externalIdSecretRef", "cloudwatch[*].secret_key": "cloudwatch[*].secretKeySecretRef", "splunk[*].token": "splunk[*].tokenSecretRef"}
}
