...
type TokenObservation struct {
	...
	// (String) Generated registration token value returned by Palette.
...
// Token is the Schema for the Tokens API. Resource for managing registration tokens in Spectro Cloud.
