...
func (mg *Cloudstack) GetTerraformResourceType() string {
	return "spectrocloud_cloudaccount_cloudstack"
}
...
func (tr *Cloudstack) GetObservation() (map[string]any, error) {
...
func (tr *Cloudstack) SetObservation(obs map[string]any) error {
...
func (tr *Cloudstack) GetParameters() (map[string]any, error) {
...
func (tr *Cloudstack) SetParameters(params map[string]any) error {
...
// GetInitParameters of this Cloudstack
func (tr *Cloudstack) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this Cloudstack
func (tr *Cloudstack) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
...
// LateInitialize this Cloudstack using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *Cloudstack) LateInitialize(attrs []byte) (bool, error) {
	params := &CloudstackParameters{}
