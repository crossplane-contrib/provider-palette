...
type ManifestInitParameters struct {
	...
	// (String) Readable name for the application profile.
...
type PackInitParameters struct {
	...
	// (Map of String) Map of property name to string value required by the pack tier (for example, databaseName or databaseVolumeSize).
