...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *EdgeNativePackObservation) DeepCopyInto(out *EdgeNativePackObservation) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new EdgeNativePackObservation.
func (in *EdgeNativePackObservation) DeepCopy() *EdgeNativePackObservation {
	if in == nil {
		return nil
	}
	out := new(EdgeNativePackObservation)
	in.DeepCopyInto(out)
	return out
}
...
func (in *EdgeNativePackParameters) DeepCopy() *EdgeNativePackParameters {
	if in == nil {
		return nil
	}
	out := new(EdgeNativePackParameters)
	in.DeepCopyInto(out)
	return out
}
...
func (in *EdgeNativeParameters) DeepCopyInto(out *EdgeNativeParameters) {
	*out = *in
	...
	if in.Pack != nil {
		in, out := &in.Pack, &out.Pack
		*out = make([]EdgeNativePackParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
