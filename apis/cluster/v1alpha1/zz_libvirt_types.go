...
type AttachedDisksInitParameters struct {
...
type GpuDeviceInitParameters struct {
	...
	// Vendor `vendor` is the GPU vendor, for eg., NVIDIA or AMD
	Vendor *string `json:"vendor,omitempty" tf:"vendor,omitempty"`
}
...
type GpuDeviceParameters struct {
...
type LibvirtBackupPolicyInitParameters struct {
...
type LibvirtCloudConfigInitParameters struct {
...
type LibvirtClusterProfileInitParameters struct {

	// The ID of the cluster profile.
	ID *string `json:"id,omitempty" tf:"id,omitempty"`

	// For packs of type `spectro`, `helm`, and `manifest`, at least one pack must be specified.
	Pack []LibvirtClusterProfilePackInitParameters `json:"pack,omitempty" tf:"pack,omitempty"`
}
...
type LibvirtClusterProfilePackInitParameters struct {
	Manifest []LibvirtClusterProfilePackManifestInitParameters `json:"manifest,omitempty" tf:"manifest,omitempty"`
...
type LibvirtClusterProfilePackManifestInitParameters struct {
...
type LibvirtClusterRbacBindingInitParameters struct {
...
type LibvirtClusterRbacBindingSubjectsInitParameters struct {
...
type LibvirtHostConfigInitParameters struct {
...
type LibvirtInitParameters struct {
	...
	BackupPolicy []LibvirtBackupPolicyInitParameters `json:"backupPolicy,omitempty" tf:"backup_policy,omitempty"`

	CloudAccountID *string `json:"cloudAccountId,omitempty" tf:"cloud_account_id,omitempty"`

	CloudConfig []LibvirtCloudConfigInitParameters `json:"cloudConfig,omitempty" tf:"cloud_config,omitempty"`
	...
	ClusterProfile []LibvirtClusterProfileInitParameters `json:"clusterProfile,omitempty" tf:"cluster_profile,omitempty"`

	// The RBAC binding for the cluster.
	ClusterRbacBinding []LibvirtClusterRbacBindingInitParameters `json:"clusterRbacBinding,omitempty" tf:"cluster_rbac_binding,omitempty"`

	// The context of the Libvirt cluster. Allowed values are `project` or `tenant`. Default is `project`. If  the `project` context is specified, the project name will sourced from the provider configuration parameter [`project_name`](https://registry.io/providers/spectrocloud/spectrocloud/latest/docs#schema).
	...
	HostConfig []LibvirtHostConfigInitParameters `json:"hostConfig,omitempty" tf:"host_config,omitempty"`

	LocationConfig []LibvirtLocationConfigInitParameters `json:"locationConfig,omitempty" tf:"location_config,omitempty"`

	MachinePool []LibvirtMachinePoolInitParameters `json:"machinePool,omitempty" tf:"machine_pool,omitempty"`

	// The namespaces for the cluster.
	Namespaces []LibvirtNamespacesInitParameters `json:"namespaces,omitempty" tf:"namespaces,omitempty"`
	...
	ScanPolicy []LibvirtScanPolicyInitParameters `json:"scanPolicy,omitempty" tf:"scan_policy,omitempty"`
...
type LibvirtLocationConfigInitParameters struct {
...
type LibvirtMachinePoolInitParameters struct {
	...
	Node []LibvirtMachinePoolNodeInitParameters `json:"node,omitempty" tf:"node,omitempty"`
	...
	Taints []LibvirtMachinePoolTaintsInitParameters `json:"taints,omitempty" tf:"taints,omitempty"`

	// Update strategy for the machine pool. Valid values are `RollingUpdateScaleOut` and `RollingUpdateScaleIn`.
	UpdateStrategy *string `json:"updateStrategy,omitempty" tf:"update_strategy,omitempty"`

	// XSL template to use.
	XslTemplate *string `json:"xslTemplate,omitempty" tf:"xsl_template,omitempty"`
}

type LibvirtMachinePoolNodeInitParameters struct {
...
type LibvirtMachinePoolNodeObservation struct {
...
type LibvirtMachinePoolNodeParameters struct {
...
type LibvirtMachinePoolObservation struct {
	...
	Node []LibvirtMachinePoolNodeObservation `json:"node,omitempty" tf:"node,omitempty"`
	...
	Taints []LibvirtMachinePoolTaintsObservation `json:"taints,omitempty" tf:"taints,omitempty"`
...
type LibvirtMachinePoolParameters struct {
	...
	// +kubebuilder:validation:Optional
	Node []LibvirtMachinePoolNodeParameters `json:"node,omitempty" tf:"node,omitempty"`
...
type LibvirtMachinePoolTaintsInitParameters struct {
...
type LibvirtNamespacesInitParameters struct {
...
type LibvirtObservation struct {
	...
	// The backup policy for the cluster. If not specified, no backups will be taken.
	BackupPolicy []LibvirtBackupPolicyObservation `json:"backupPolicy,omitempty" tf:"backup_policy,omitempty"`

	CloudAccountID *string `json:"cloudAccountId,omitempty" tf:"cloud_account_id,omitempty"`

	CloudConfig []LibvirtCloudConfigObservation `json:"cloudConfig,omitempty" tf:"cloud_config,omitempty"`
	...
	// The RBAC binding for the cluster.
	ClusterRbacBinding []LibvirtClusterRbacBindingObservation `json:"clusterRbacBinding,omitempty" tf:"cluster_rbac_binding,omitempty"`
	...
	// The host configuration for the cluster.
	HostConfig []LibvirtHostConfigObservation `json:"hostConfig,omitempty" tf:"host_config,omitempty"`
	...
	LocationConfig []LibvirtLocationConfigObservation `json:"locationConfig,omitempty" tf:"location_config,omitempty"`

	MachinePool []LibvirtMachinePoolObservation `json:"machinePool,omitempty" tf:"machine_pool,omitempty"`

	// The namespaces for the cluster.
	Namespaces []LibvirtNamespacesObservation `json:"namespaces,omitempty" tf:"namespaces,omitempty"`
	...
	// The scan policy for the cluster.
	ScanPolicy []LibvirtScanPolicyObservation `json:"scanPolicy,omitempty" tf:"scan_policy,omitempty"`
...
type LibvirtParameters struct {
	...
	// +kubebuilder:validation:Optional
	CloudConfig []LibvirtCloudConfigParameters `json:"cloudConfig,omitempty" tf:"cloud_config,omitempty"`
	...
	// +kubebuilder:validation:Optional
	MachinePool []LibvirtMachinePoolParameters `json:"machinePool,omitempty" tf:"machine_pool,omitempty"`
...
type LibvirtScanPolicyInitParameters struct {
...
type MachinePoolInstanceTypeInitParameters struct {
	AttachedDisks []AttachedDisksInitParameters `json:"attachedDisks,omitempty" tf:"attached_disks,omitempty"`
...
type MachinePoolInstanceTypeObservation struct {
	AttachedDisks []AttachedDisksObservation `json:"attachedDisks,omitempty" tf:"attached_disks,omitempty"`
...
type PlacementsInitParameters struct {
	ApplianceID *string `json:"applianceId,omitempty" tf:"appliance_id,omitempty"`

	DataStoragePool *string `json:"dataStoragePool,omitempty" tf:"data_storage_pool,omitempty"`

	GpuDevice []GpuDeviceInitParameters `json:"gpuDevice,omitempty" tf:"gpu_device,omitempty"`

	ImageStoragePool *string `json:"imageStoragePool,omitempty" tf:"image_storage_pool,omitempty"`

	Network *string `json:"network,omitempty" tf:"network,omitempty"`

	NetworkNames *string `json:"networkNames,omitempty" tf:"network_names,omitempty"`

	NetworkType *string `json:"networkType,omitempty" tf:"network_type,omitempty"`

	TargetStoragePool *string `json:"targetStoragePool,omitempty" tf:"target_storage_pool,omitempty"`
}
...
type PlacementsObservation struct {
	...
	GpuDevice []GpuDeviceObservation `json:"gpuDevice,omitempty" tf:"gpu_device,omitempty"`
...
type PlacementsParameters struct {
	...
	// +kubebuilder:validation:Optional
	GpuDevice []GpuDeviceParameters `json:"gpuDevice,omitempty" tf:"gpu_device,omitempty"`
...
type LibvirtSpec struct {
	...
	// autoscaler.
	InitProvider LibvirtInitParameters `json:"initProvider,omitempty"`
}
