...
type EdgeClusterProfileObservation struct {
	...
	// +kubebuilder:validation:Optional
	Pack []EdgeClusterProfilePackObservation `json:"pack,omitempty" tf:"pack,omitempty"`
}
...
type EdgeClusterProfilePackObservation struct {
	...
	// +kubebuilder:validation:Optional
	Manifest []EdgeClusterProfilePackManifestObservation `json:"manifest,omitempty" tf:"manifest,omitempty"`
}
...
type EdgeObservation struct {
	...
	// +kubebuilder:validation:Optional
	ClusterProfile []EdgeClusterProfileObservation `json:"clusterProfile,omitempty" tf:"cluster_profile,omitempty"`
