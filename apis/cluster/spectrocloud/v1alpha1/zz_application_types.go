...
type ApplicationInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/crossplane-contrib/provider-palette/apis/cluster/application/v1alpha1.Profile
...
type ConfigInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/crossplane-contrib/provider-palette/apis/cluster/virtual/v1alpha1.Cluster
...
// Application is the Schema for the Applications API. Resource for managing applications deployed through Spectro Cloud.
