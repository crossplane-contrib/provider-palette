...
type ProjectRoleInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/crossplane-contrib/provider-palette/apis/cluster/spectrocloud/v1alpha1.Role
	// +listType=set
...
type ResourceRoleInitParameters struct {
	...
	// List of filter ids.
	// +crossplane:generate:reference:type=github.com/crossplane-contrib/provider-palette/apis/cluster/spectrocloud/v1alpha1.Filter
	// +listType=set
...
type UserInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/crossplane-contrib/provider-palette/apis/cluster/spectrocloud/v1alpha1.Team
...
type WorkspaceRoleWorkspaceInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/crossplane-contrib/provider-palette/apis/cluster/spectrocloud/v1alpha1.Workspace
	ID *string `json:"id,omitempty" tf:"id,omitempty"`
