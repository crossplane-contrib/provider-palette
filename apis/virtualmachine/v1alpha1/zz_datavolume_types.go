...
type VolumeSourceDataVolumeInitParameters struct {
	Hotpluggable *bool `json:"hotpluggable,omitempty" tf:"hotpluggable,omitempty"`

	Name *string `json:"name,omitempty" tf:"name,omitempty"`
}

type VolumeSourceDataVolumeObservation struct {
	Hotpluggable *bool `json:"hotpluggable,omitempty" tf:"hotpluggable,omitempty"`

	Name *string `json:"name,omitempty" tf:"name,omitempty"`
}

type VolumeSourceDataVolumeParameters struct {
...
type VolumeSourceInitParameters struct {
	DataVolume []VolumeSourceDataVolumeInitParameters `json:"dataVolume,omitempty" tf:"data_volume,omitempty"`
}

type VolumeSourceObservation struct {
	DataVolume []VolumeSourceDataVolumeObservation `json:"dataVolume,omitempty" tf:"data_volume,omitempty"`
}

type VolumeSourceParameters struct {

	// +kubebuilder:validation:Optional
	DataVolume []VolumeSourceDataVolumeParameters `json:"dataVolume" tf:"data_volume,omitempty"`
}
