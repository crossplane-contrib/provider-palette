...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TencentInitParameters) DeepCopyInto(out *TencentInitParameters) {
	*out = *in
	if in.Context != nil {
		in, out := &in.Context, &out.Context
		*out = new(string)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TencentInitParameters.
func (in *TencentInitParameters) DeepCopy() *TencentInitParameters {
	if in == nil {
		return nil
	}
	out := new(TencentInitParameters)
	in.DeepCopyInto(out)
	return out
}
