...
type BackupPolicyInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/crossplane-contrib/provider-palette/apis/backup/v1alpha1.BackupStorageLocation
	BackupLocationID *string `json:"backupLocationId,omitempty" tf:"backup_location_id,omitempty"`

	// Reference to a BackupStorageLocation in backup to populate backupLocationId.
	// +kubebuilder:validation:Optional
	BackupLocationIDRef *v1.Reference `json:"backupLocationIdRef,omitempty" tf:"-"`

	// Selector for a BackupStorageLocation in backup to populate backupLocationId.
	// +kubebuilder:validation:Optional
...
type ClusterProfileInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/crossplane-contrib/provider-palette/apis/clusterprofile/v1alpha1.ClusterProfile
	ID *string `json:"id,omitempty" tf:"id,omitempty"`

	// Reference to a ClusterProfile in clusterprofile to populate id.
	// +kubebuilder:validation:Optional
	IDRef *v1.Reference `json:"idRef,omitempty" tf:"-"`

	// Selector for a ClusterProfile in clusterprofile to populate id.
	// +kubebuilder:validation:Optional
...
type EdgeVSphereClusterInitParameters struct {
...
type EdgeVSphereClusterObservation struct {
...
type EdgeVSphereClusterParameters struct {
...
// EdgeVSphereClusterSpec defines the desired state of EdgeVSphereCluster
type EdgeVSphereClusterSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     EdgeVSphereClusterParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider EdgeVSphereClusterInitParameters `json:"initProvider,omitempty"`
}

// EdgeVSphereClusterStatus defines the observed state of EdgeVSphereCluster.
type EdgeVSphereClusterStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        EdgeVSphereClusterObservation `json:"atProvider,omitempty"`
}
...
// EdgeVSphereCluster is the Schema for the EdgeVSphereClusters API. <no value>
// +kubebuilder:printcolumn:name="SYNCED",type="string",JSONPath=".status.conditions[?(@.type=='Synced')].status"
// +kubebuilder:printcolumn:name="READY",type="string",JSONPath=".status.conditions[?(@.type=='Ready')].status"
// +kubebuilder:printcolumn:name="EXTERNAL-NAME",type="string",JSONPath=".metadata.annotations.crossplane\\.io/external-name"
// +kubebuilder:printcolumn:name="AGE",type="date",JSONPath=".metadata.creationTimestamp"
// +kubebuilder:resource:scope=Cluster,categories={crossplane,managed,palette}
type EdgeVSphereCluster struct {
	...
	Spec   EdgeVSphereClusterSpec   `json:"spec"`
	Status EdgeVSphereClusterStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// EdgeVSphereClusterList contains a list of EdgeVSphereClusters
type EdgeVSphereClusterList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []EdgeVSphereCluster `json:"items"`
}

// Repository type metadata.
var (
	EdgeVSphereCluster_Kind             = "EdgeVSphereCluster"
	EdgeVSphereCluster_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: EdgeVSphereCluster_Kind}.String()
	EdgeVSphereCluster_KindAPIVersion   = EdgeVSphereCluster_Kind + "." + CRDGroupVersion.String()
	EdgeVSphereCluster_GroupVersionKind = CRDGroupVersion.WithKind(EdgeVSphereCluster_Kind)
)

func init() {
	SchemeBuilder.Register(&EdgeVSphereCluster{}, &EdgeVSphereClusterList{})
}
