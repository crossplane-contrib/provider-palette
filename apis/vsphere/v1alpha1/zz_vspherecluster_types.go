...
type VSphereClusterInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/crossplane-contrib/provider-palette/apis/vsphere/v1alpha1.VSphereCloudAccount
	CloudAccountID *string `json:"cloudAccountId,omitempty" tf:"cloud_account_id,omitempty"`

	// Reference to a VSphereCloudAccount in vsphere to populate cloudAccountId.
	// +kubebuilder:validation:Optional
	CloudAccountIDRef *v1.Reference `json:"cloudAccountIdRef,omitempty" tf:"-"`

	// Selector for a VSphereCloudAccount in vsphere to populate cloudAccountId.
	// +kubebuilder:validation:Optional
...
// VSphereCluster is the Schema for the VSphereClusters API. A resource to manage a vSphere cluster in Palette.
