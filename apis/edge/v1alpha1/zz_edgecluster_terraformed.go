...
// GetInitParameters of this EdgeCluster
func (tr *EdgeCluster) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this EdgeCluster
func (tr *EdgeCluster) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
