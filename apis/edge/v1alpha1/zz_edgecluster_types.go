...
type EdgeClusterInitParameters struct {
...
type EdgeClusterSpec struct {
	...
	// autoscaler.
	InitProvider EdgeClusterInitParameters `json:"initProvider,omitempty"`
}
...
// EdgeCluster is the Schema for the EdgeClusters API. Resource for managing Edge Native clusters in Spectro Cloud through Palette.
