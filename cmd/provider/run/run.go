...
func Run() {
	var (
		...
		// Note: External Secret Store flags removed as ESS functionality was removed in Crossplane v2
	...
	// Note: External Secret Store setup removed as ESS functionality was removed in Crossplane v2
