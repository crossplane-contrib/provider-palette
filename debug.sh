...
show_help() {
    ...
    echo "  (none)   Run the Crossplane provider normally"
    echo ""
    ...
    echo ""
    echo "Examples:"
    echo "  $0           # Run Crossplane provider in normal mode"
